...
function renderLicenseBadge(license) {  // Here is the function to render in the badges.
  if (license ==='Mozilla') {
...
// If there is no license, return an empty string
function renderLicenseSection(license) {  //this function renders the whole license and combines it into a clickable badge that takes you the the license link.
